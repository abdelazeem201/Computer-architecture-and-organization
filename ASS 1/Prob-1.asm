 #
 #Write a complete MIPS program to collect a non-negative integer from the user, and then to calculate and
 #display the sum of its digits. After the input number is collected from the user, there should be sanity
